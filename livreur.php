...
$SaisieId=$_POST ["ID"];
$requete= "INSERT INTO `rdv_livreur`( `adresse_de_recuperation`, `adresse_de_livraison`, `date_de_livraison`, `ID_clients`) VALUES ('$saisie_recuperation','$saisie_destination','$saisie_date_de_recuperation','$SaisieId')";

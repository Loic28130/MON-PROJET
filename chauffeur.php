...
$SaisieId=$_POST ["ID"];
$requete= "INSERT INTO `rdv_chauffeur`( `lieux de depart`, `adresse arrivee`, `date de depart`, `heure de depart`, `IDclient`)  VALUES ('$saisie_lieux_de_depart','$saisie_adresse_arrivee','$saisie_date_de_depart','$saisie_heure_de_depart','$SaisieId')";

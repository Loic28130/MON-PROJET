...
$saisie_ID=$_POST ["ID"];
$requete= "INSERT INTO `paiement`( `nom`, `prenom`, `date`, `prix`, `ID_RDV_chauffeur`, `ID_RDV_livreur`) VALUES ('$saisie_nom','$saisie_prenom','$saisie_dateDeDepart','$saisie_prix',`$saisie_ID`)";
